...
LOCALE_PATHS = [
    os.path.join(BASE_DIR, 'comparison/translations'),
]

# statici18n
# http://django-statici18n.readthedocs.io/en/latest/settings.html

with open(os.path.join(BASE_DIR, 'comparison/translations/config.yaml'), 'r') as locale_config_file:
...
STATICI18N_NAMESPACE = 'СomparisonXBlockI18N'
STATICI18N_PACKAGES = (
    'comparison',
)
STATICI18N_ROOT = 'comparison/public/js'
